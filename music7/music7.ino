...
void set_freq(float vel) {
  ...
  float freq1 = map(vel_amp, 0, 6000, 500, 800);
  float freq2 = map(vel_amp, 0, 6000, 50, 500);
  float freq3 = map(vel_amp, 0, 6000, 800, 1500);

  Music.setFrequency1(freq1);
  Music.setFrequency2(freq2);
  Music.setFrequency3(freq3);
