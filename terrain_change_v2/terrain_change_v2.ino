...
void freqT0B(){
  ...
  int newxB = analogRead(A9);
  int newDis = newxA + newxB;
  int T0BFreq = map(BF, 0, 512, 10, 250);
...
void freqT1A(){
  ...
  int newxB = analogRead(A9);
  int newDis = newxA + newxB;
  int T1AFreq = map(AF, 0, 512, 40, 300);
...
void freqT1B(){
  ...
  int newxB = analogRead(A9);
  int newDis = newxA + newxB;
  int T1BFreq = map(BF, 0, 512, 10, 250);
...
void freqT2A(){
  ...
  int newxB = analogRead(A9);
  int newDis = newxA + newxB;
  int T2AFreq = map(AF, 0, 512, 40, 300);
  Music.setWaveform(SINE);
...
void freqT2B(){
  ...
  int newxB = analogRead(A9);
  int newDis = newxA + newxB;
  int T2BFreq = map(BF, 0, 512, 10, 250);
...
void freqT3A(){
  ...
  int newxB = analogRead(A9);
  int newDis = newxA + newxB;
  int T3AFreq = map(AF, 0, 512, 40, 300);
...
void freqT3B(){
  ...
  int newxB = analogRead(A9);
  int newDis = newxA + newxB;
  int T3BFreq = map(BF, 0, 512, 10, 250);
